...
export class Web3AuthMPCCoreKit implements IWeb3Auth {
  ...
  public async generateFactor(
    ...
    try {
      ...
      await this.copyFactorPub(shareCategory || ShareType.RECOVERY, factorPub);
  ...
  public async importFactor(factorKey: BN): Promise<void> {
    if (!factorKey) {
