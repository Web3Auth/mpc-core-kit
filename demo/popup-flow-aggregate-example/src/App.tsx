...
import { Web3AuthMPCCoreKit, WEB3AUTH_NETWORK, Point, AggregateVerifierLoginParams, TssShareType, storeWebBrowserFactor, getWebBrowserFactor, COREKIT_STATUS, TssSecurityQuestion, generateFactorKey } from "@web3auth/mpc-core-kit";
  ...
  return (
    <div className="container">
      <h1 className="title">
        ...
        Popup Flow Aggregate Verifier Example
      </h1>
