...
export declare class Web3AuthMPCCoreKit implements ICoreKit {
    ...
    loginWithOauth(params: OauthLoginParams, importTssKey?: string): Promise<void>;
    loginWithJWT(idTokenLoginParams: IdTokenLoginParams, importTssKey?: string): Promise<void>;
